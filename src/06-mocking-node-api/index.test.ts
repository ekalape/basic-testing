...
import { readFileAsynchronously, doStuffByInterval, doStuffByTimeout } from './index';
...
describe('readFileAsynchronously', () => {
  ...
  test('should return file content if file exists', async () => {
    ...
    const fakeReadFile = jest.spyOn(fsPromises, "readFile").mockResolvedValue("file content");
